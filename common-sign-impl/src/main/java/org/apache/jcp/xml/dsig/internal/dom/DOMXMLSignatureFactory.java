...
public final class DOMXMLSignatureFactory extends XMLSignatureFactory {
    ...
    public DigestMethod newDigestMethod(String algorithm,
        ...
        } else if (DOMDigestMethod.GOST3411.contains(algorithm)) {
            return new DOMDigestMethod.GOST3411(params, algorithm);
        } else if (DOMDigestMethod.GOST3411_2012_256.contains(algorithm)) {
            return new DOMDigestMethod.GOST3411_2012_256(params, algorithm);
        } else if (DOMDigestMethod.GOST3411_2012_512.contains(algorithm)) {
            return new DOMDigestMethod.GOST3411_2012_512(params, algorithm);
        } else {
    ...
    public SignatureMethod newSignatureMethod(String algorithm,
        ...
        } else if (DOMSignatureMethod.GOST3410_GOST3411.contains(algorithm)) {
            return new DOMSignatureMethod.GOST3411withECGOST3410(params, algorithm);
        } else if (DOMSignatureMethod.GOST3410_2012_GOST3411_2012_256.contains(algorithm)) {
            return new DOMSignatureMethod.GOST34112012256withECGOST34102012(params, algorithm);
        } else if (DOMSignatureMethod.GOST3410_2012_GOST3411_2012_512.contains(algorithm)) {
            return new DOMSignatureMethod.GOST34112012512withECGOST34102012(params, algorithm);
        } else {
            throw new NoSuchAlgorithmException("unsupported algorithm");
        }
    }
